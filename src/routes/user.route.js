...
import { authRateLimiter, bookingRateLimiter, searchRateLimiter } from "../middlewares/rateLimiter.js";
...
router.route("/available-seats/:scheduleId").get(searchRateLimiter ,getAvailableSeats);
router
...
router.route("/bookings/get-booking").get(verifyJWT, searchRateLimiter, getBookingByPNR);
router
